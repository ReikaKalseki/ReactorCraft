...
public class ReactorRecipes {
	...
	private static void addItems() {
		...
		GameRegistry.addRecipe(ReactorItems.BREEDERFUEL.getStackOf(), " D ", "DED", " D ", 'D', ReactorItems.DEPLETED.getStackOf(), 'E', ReactorItems.FUEL.getStackOf());
	...
	private static void addMachines() {
		...
		ReactorTiles.BOILER.addCrafting(" i ", "ibi", " i ", 'b', ReactorTiles.BOILER.getCraftedProduct(), 'i', Item.ingotIron);
