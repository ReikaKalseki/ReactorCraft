...
public class RenderSolarExchanger extends ReactorRenderBase
{
	 ...
	 */
	public void renderTileEntitySolarExchangerAt(TileEntitySolarExchanger tile, double par2, double par4, double par6, float par8)
	{
	...
	public void renderTileEntityAt(TileEntity tile, double par2, double par4, double par6, float par8)
	{
		if (this.doRenderModel((TileEntityReactorBase)tile))
			this.renderTileEntitySolarExchangerAt((TileEntitySolarExchanger)tile, par2, par4, par6, par8);
