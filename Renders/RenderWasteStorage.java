...
public class RenderWasteStorage extends ReactorRenderBase
{
	 ...
	 */
	public void renderTileEntityWasteStorageAt(TileEntityWasteStorage tile, double par2, double par4, double par6, float par8)
	{
	...
	public void renderTileEntityAt(TileEntity tile, double par2, double par4, double par6, float par8)
	{
		if (this.doRenderModel((TileEntityReactorBase)tile))
			this.renderTileEntityWasteStorageAt((TileEntityWasteStorage)tile, par2, par4, par6, par8);
	}
