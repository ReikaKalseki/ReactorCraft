...
public class DuctRenderer extends ReactorRenderBase
{
	 ...
	 */
	public void renderTileEntityGasDuctAt(TileEntityGasDuct tile, double par2, double par4, double par6, float par8)
	{
	...
	public void renderTileEntityAt(TileEntity tile, double par2, double par4, double par6, float par8)
	{
		if (this.isValidMachineRenderpass((TileEntityReactorBase)tile))
			this.renderTileEntityGasDuctAt((TileEntityGasDuct)tile, par2, par4, par6, par8);
	}
