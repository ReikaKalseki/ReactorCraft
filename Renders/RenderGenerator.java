...
public class RenderGenerator extends ReactorRenderBase
{
	...
	public void renderTileEntityReactorGeneratorAt(TileEntityReactorGenerator tile, double par2, double par4, double par6, float par8)
	{
		...
		if (tile.isInWorld()) {
			if (tile.hasMultiblock)
				...
				Icon ico = ReactorBlocks.GENERATORMULTI.getBlockVariable().getIcon(0, -1);
	...
	public void renderTileEntityAt(TileEntity tile, double par2, double par4, double par6, float par8)
	{
		if (this.isValidMachineRenderpass((TileEntityReactorBase)tile))
			this.renderTileEntityReactorGeneratorAt((TileEntityReactorGenerator)tile, par2, par4, par6, par8);
